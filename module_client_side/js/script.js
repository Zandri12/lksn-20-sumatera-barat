...
var _do = {
    ...
    updateScore: function() {
        $("#score").html("Score <br>" + Math.floor(window.snake.length))
    },
...
var _core = {
    ...
    gameOver: function() {
        ...
        button.innerHTML ="<p>You Are Dead</p></b><br /><br /><input type='button' value='Play Again' onclick='window.location.reload();' />";
...
$(document).ready(function() {
    ...
    $('#about').click(function() {
        window.alert("Use arrow keys or WASD,don't hit the wall...and take the meal for grow up your snake");
    });
